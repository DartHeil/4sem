...
Cannon::Cannon(Image &image, float X, float Y,int W,int H,String Name) : Entity(image,X,Y,0,0,Name)
{
	FireRate = 1;
...
void Cannon::update(float xnew, float ynew, bool life, RenderWindow& window)
{
	if (name == "Cannon1")
	{
		x = xnew;
